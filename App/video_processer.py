...
class video_processer():
      ...
      def toH264(self,video_name ="video.avi"):
          ...
          cmdline = "conda info --env&&source deactivate&&ffmpeg -i {} -vcodec h264 {}".format(origin_video, convert_video)
          # cmdline = "#!/bin/bash&&source deactivate Django&&ffmpeg -i {} -vcodec h264 {}&&source activate Django".format(origin_video, convert_video)
